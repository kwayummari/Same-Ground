...
<div class="p-tab" id="p-tab-4">
                        <div class="project-carousel owl-theme owl-carousel">
							...
							<div class="gallery-block style-two">
								<div class="inner-box">
									<div class="image">
										<img src="images/women/awards/12.jpg" alt="" />
							...
							<div class="gallery-block style-two">
								<div class="inner-box">
									<div class="image">
										<img src="images/women/awards/11.jpg" alt="" />
										<div class="overlay-box">
											<div class="options">
												<a href="projects-detail.html" class="plus-icon"><span class="icon flaticon-unlink"></span></a>
							...
							<div class="gallery-block style-two">
								<div class="inner-box">
									<div class="image">
										<img src="images/women/awards/10.jpg" alt="" />
										<div class="overlay-box">
											<div class="options">
												<a href="projects-detail.html" class="plus-icon"><span class="icon flaticon-unlink"></span></a>
							...
							<div class="gallery-block style-two">
								<div class="inner-box">
									<div class="image">
										<img src="images/women/awards/9.jpg" alt="" />
										<div class="overlay-box">
											<div class="options">
												<a href="projects-detail.html" class="plus-icon"><span class="icon flaticon-unlink"></span></a>
